...
bool BaseObject::LoadImg(std::string path, SDL_Renderer* screen)
{
	...
	if (load_suface != NULL)
	{
		SDL_SetColorKey(load_suface, SDL_TRUE, SDL_MapRGB(load_suface->format, COLOR_KEY_R, COLOR_KEY_G, COLOR_KEY_B));// xoa vien backgroud
...
void BaseObject::Free() //giai phong cac doi tuong
{
	if (p_object_ != NULL)
	{
