...
bool InitData()
{
	...
	g_window = SDL_CreateWindow("Game SDL 2.0: phamanhminh 20020444",
...
int main(int argc, char* argv[])
{
	...
	player_money.SetPos(SCREEN_WIDTH * 0.5 - 300, 8);//8  300
	...
	while (!is_quit)
	{
		...
		Uint32 time_val = SDL_GetTicks() / 1000;//1000
		Uint32 val_time = 300 - time_val;      //300
		if(val_time <=0 )
			{
				if (MessageBox(NULL, L"GAME OVER", L"Info", MB_OK | MB_ICONSTOP) == IDOK)
				{
